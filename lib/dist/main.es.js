...
class BaseText extends LitElement {
  ...
  render() {
    if (this.tag || this.look) {
      switch (this.tag || this.look) {
        case "h1":
...
export { BaseBox, BaseButton, BaseCheckbox, BaseContainer, BaseFlex, BaseGrid, BaseGridItem, BaseInput, BaseLabel, BaseModal, BaseOptGroup, BaseOption, BaseRadio, BaseSelect, BaseText, BaseToggle };
