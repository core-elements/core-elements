...
var styles$c = css`:host{display:inline-block}:host([full]){display:block;width:100%}button{border:0;font-size:var(--base-font-size-sm);background:0;outline:0;padding:0 var(--base-space-sm);margin-right:var(--base-space-sm);height:var(--base-size-md);border-bottom:2px solid transparent}button:hover{border-bottom:2px solid var(--base-color-ui-light)}:host([selected]) button{border-bottom:2px solid var(--base-color-focus)}`;
...
var styles$g = css`:host{display:block}:host [part=label]{display:-webkit-box;display:flex;height:var(--base-size-sm);-webkit-box-align:center;align-items:center;font-weight:400;color:var(--base-color-font);padding:var(--base-space-xs);text-transform:uppercase;font-size:var(--base-font-size-xs)}:host [part=list]{list-style:none;padding:0;margin:0}::slotted([slot=prepend]){margin-right:var(--base-space-sm)}`;
